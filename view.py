...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ok_x_spinBox_1 = QtWidgets.QSpinBox(parent=self.groupBox_2)
        self.ok_x_spinBox_1.setGeometry(QtCore.QRect(10, 40, 71, 22))
        self.ok_x_spinBox_1.setMinimum(-1000)
        self.ok_x_spinBox_1.setMaximum(1000)
        self.ok_x_spinBox_1.setObjectName("ok_x_spinBox_1")
        self.ok_y_spinBox_2 = QtWidgets.QSpinBox(parent=self.groupBox_2)
        self.ok_y_spinBox_2.setGeometry(QtCore.QRect(10, 100, 71, 22))
        self.ok_y_spinBox_2.setMinimum(-1000)
        self.ok_y_spinBox_2.setMaximum(1000)
        self.ok_y_spinBox_2.setProperty("value", 1)
        self.ok_y_spinBox_2.setObjectName("ok_y_spinBox_2")
        self.label_7 = QtWidgets.QLabel(parent=self.groupBox_2)
        self.label_7.setGeometry(QtCore.QRect(10, 80, 111, 16))
        self.label_7.setObjectName("label_7")
        self.ok_r_spinBox_3 = QtWidgets.QSpinBox(parent=self.groupBox_2)
        self.ok_r_spinBox_3.setGeometry(QtCore.QRect(160, 40, 71, 22))
        self.ok_r_spinBox_3.setMinimum(-1000)
        self.ok_r_spinBox_3.setMaximum(1000)
        self.ok_r_spinBox_3.setObjectName("ok_r_spinBox_3")
